...
public class WriteProjectService implements ERPServiceInterface {
	...
	public ERPForwardService Process(HttpServletRequest request, HttpServletResponse response)
		...
		ProjectManager pm = new ProjectManager(projectName, memberNum,comment , startDate, endDate);
		ProjectDao dao = ProjectDao.getInstance();
		dao.getInsertProject(pm);
