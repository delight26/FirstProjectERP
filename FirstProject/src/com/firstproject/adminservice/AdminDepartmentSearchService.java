...
public class AdminDepartmentSearchService implements ERPServiceInterface{
	...
	public ERPForwardService Process(HttpServletRequest request, HttpServletResponse response)
		...
		forward.setView("./Admin/AdminDepartmentSearchForm.jsp");
